        ...
        <div className="flex flex-col py-10 px-4 sm:px-6 md:px-10 lg:px-20 bg-[#F3EBE5] min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
                <button
                    ...
                    className={`flex-1 bg-gradient-to-r from-green-500 to-teal-600 hover:from-teal-600 hover:to-green-500 text-white font-semibold py-3 px-6 rounded-lg shadow-md ${publishLoading ? "opacity-50 cursor-not-allowed" : ""
                        }`}
                >
